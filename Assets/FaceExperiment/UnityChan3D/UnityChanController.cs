...
public class UnityChanController : MonoBehaviour, ISaveable
{
  ...
  [SerializeField] private float roll = 0, pitch = 0, yaw = 0;
  // private float x_ratio_left = 0, y_ratio_left = 0, x_ratio_right = 0, y_ratio_right = 0;
    [SerializeField] private float ear_left = 0, ear_right = 0;
    [SerializeField]private float mar = 0;

  public float Roll { get => roll; set => roll = value; }
  public float Pitch { get => pitch; set => pitch = value; }
  public float Yaw { get => yaw; set => yaw = value; }

  public float Ear_left { get => ear_left; set => ear_left = value; }
  public float Ear_right { get => ear_right; set => ear_right = value; }
  public float Mar { get => mar; set => mar = value; }
